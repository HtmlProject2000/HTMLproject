                    ...
                    <div class="div-c">
                        <form id="form-options-search-result" class="form-options">
                            <table>
                                ...
                                <tr>
                                    <td>
                                        <label for="radio-oa-az">A-Z</label>
                                        <input type="radio" id="radio-oa-az"/>
                                    </td>
                                    <td>
                                        <label for="radio-oa-za">Z-A</label>
                                        <input type="radio" id="radio-oa-za"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="titles" colspan="2">
                                ...
                                <tr>
                                    <td>
                                        <label for="radio-dtpev-cres">Crescente</label>
                                        <input type="radio" id="radio-dtpev-cre"/>
                                    </td>
                                    <td>
                                        <label for="radio-dtpev-dec">Decrescente</label>
                                        <input type="radio" id="radio-dtpev-dec"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="titles" colspan="2">
                                        Qtd. prevista de visitantes
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <label for="radio-qtd-cre">Crescente</label>
                                        <input type="radio" id="radio-qtd-cre"/>
                                    </td>
                                    <td>
                                        <label for="radio-qtd-dec">Decrescente</label>
                                        <input type="radio" id="radio-qtd-dec"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="titles" colspan="2">
                                ...
                                <tr>
                                    <td>
                                        <label for="check-only-my">Somente meus Eventos</label>
                                    </td>
                                    <td>
                                        <input type="checkbox" id="check-only-my" title="NÃ£o mostrarÃ¡ os eventos favoritos"/>
                                    </td>
                                </tr>
                            </table>
                            <input type="submit" class="submit-b" id="btn-op-ok" value="OK">
                            <input type="reset" class="reset-b" id="btn-op-eraser" value="limpar">
                        </form>
                    </div>
                </div>
                <div class="modal-footer">
